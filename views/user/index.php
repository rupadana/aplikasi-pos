						...
						<?php }?>
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="controllers/user.php?action=edit-member" enctype="multipart/form-data">
												<fieldset>
							...
							<div class="col-sm-4">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											 <form class="form-horizontal" method="POST" action="controllers/user.php?action=ganti-pass">
