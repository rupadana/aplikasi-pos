      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
				  ...
				  <?php 
				  		$data = DB::table('barang')->where("stok", "<=", 3)->get();
						$r = count($data);
						if($r > 0){
					?>	
					<?php
					...
					?>
				  <?php $hasil_barang = count(DB::table("barang")->get());?>
				  <?php $hasil_kategori =count(DB::table("kategori")->get());?>
				  <?php $stok = DB::table("barang")->select("SUM(stok) as jml")->first(); ?>
				  <?php $jual = DB::table("nota")->select("SUM(jumlah) as stok")->first(); ?>
                    <div class="row">
                      <!--STATUS PANELS -->
					  <div class="col-md-3">
