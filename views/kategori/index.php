          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<?php 
							if(!empty($_GET['uid'])){
							$edit = Kategori::find($_GET['uid']);
						?>
						<form method="POST" action="controllers/kategori.php?action=edit">
							<table>
								<tr>
						...
						<?php }else{?>
						<form method="POST" action="controllers/kategori.php?action=tambah">
							<table>
								<tr>
							...
							?>
								<tr>
									...
									<td>
										...
										<a href="controllers/kategori.php?action=delete&id=<?php echo $isi['id_kategori'];?>" onclick="javascript:return confirm('Hapus Data Kategori ?');"><button class="btn btn-danger">Hapus</button></a>
									</td>
								</tr>
							<?php $no++; }?>
							</tbody>
