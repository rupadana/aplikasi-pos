          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<?php 
							$r = count(DB::table("barang")->where("stok", "<=", 3)->get());
							if($r > 0){
						?>	
						<?php
								echo "
						...
						<div class="modal-view">
							<table class="table table-bordered table-striped" id="example1">
								...
								<?php 
									...
									$totalJual = 0;
									$totalStok = 0;
									if(isset($_GET['stok']) && $_GET['stok'] == 'yes')
									{
										$hasil = Barang::stoks();

									}else{
										$hasil = Barang::barangs();
									}
									$no=1;
										...
										<table class="table table-striped bordered">
											...
											<tr>
												...
												<select name="kategori" class="form-control" required>
													...
													<?php  $kat = Kategori::kategories(); foreach($kat as $isi){ 	?>
